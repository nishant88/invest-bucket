...
export const VentureHealth: React.FC = () => {
  ...
  return (
    <div className="space-y-4 text-left pb-16 animate-fade-in text-[#0d1c32] select-none w-full">
      
      {/* SECTION 1: Core Health Indicators Stack */}
      <section className="space-y-4">
        {/* Card 1: Venture Health Score */}
        <div className="bg-white rounded-[28px] p-5.5 card-shadow border border-outline-variant/40 relative overflow-hidden w-full">
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="font-display font-extrabold text-[16px] text-[#0d1c32] mt-0.5">Core Venture Health Score</h3>
        ...
        <div className="bg-[#0d1c32] text-white rounded-[28px] p-5.5 card-shadow border border-white/5 flex items-center justify-between relative overflow-hidden w-full">
          <div className="absolute right-0 top-0 w-28 h-28 bg-[#fae403]/15 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="space-y-2 text-left flex-1 min-w-0 pr-4">
            ...
            <div className="text-[9.5px] text-[#b2ee4a] font-bold flex items-center gap-1">
      ...
      <section className="space-y-4">
        ...
        <div className="bg-white rounded-[28px] p-5.5 card-shadow border border-outline-variant/40 flex flex-col justify-between w-full">
          <h4 className="font-display font-bold text-[11px] text-slate-500 uppercase tracking-wider block mb-4">Venture Health Gauge Dial</h4>
          
          <div className="relative flex flex-col items-center">
            <div className="relative w-44 h-22 overflow-hidden flex items-end">
              <svg className="w-44 h-44 absolute bottom-0 left-0">
                <circle cx="88" cy="88" r="76" stroke="#f1f5f9" strokeWidth="12" strokeDasharray="239 239" strokeDashoffset="0" fill="transparent" strokeLinecap="round" />
                <circle cx="88" cy="88" r="76" stroke={healthData.status === 'Green' ? '#10b981' : healthData.status === 'Amber' ? '#f59e0b' : '#f43f5e'} strokeWidth="12" strokeDasharray="239 239" strokeDashoffset={239 - (239 * (healthData.score / 100))} fill="transparent" strokeLinecap="round" />
              </svg>
              <div 
                className="absolute bottom-0 left-1/2 w-1.5 h-18 bg-[#0d1c32] origin-bottom -translate-x-1/2 transition-all duration-1000 rounded-t-full"
                style={{ transform: `translateX(-50%) rotate(${gaugeAngle}deg)` }}
              />
              <div className="absolute bottom-0 left-1/2 w-4 h-4 bg-[#0d1c32] rounded-full border-2 border-white -translate-x-1/2 translate-y-2 z-10" />
            </div>

            <div className="text-center mt-4">
              <span className="text-[22px] font-black text-[#0d1c32]">{healthData.score}</span>
              <span className="text-[10px] font-bold text-slate-500 block mt-0.5">Stability Index Score</span>
            </div>
          </div>
        </div>

        {/* Card 2: Risk Severity Table */}
        <div className="bg-white rounded-[28px] p-5.5 card-shadow border border-outline-variant/40 w-full space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3.5 pt-1">
            <div className="p-3.5 rounded-2xl border border-outline-variant/20 flex flex-col justify-between bg-slate-50/60 h-[75px]">
      ...
      <section className="space-y-4">
        ...
        <div className="bg-[#ecf3e3] rounded-[28px] p-5.5 border border-outline-variant/30 text-[#0d1c32] relative overflow-hidden flex flex-col justify-between w-full">
          ...
          <div className="space-y-2 relative z-10">
            ...
            <p className="text-[12.5px] font-bold leading-relaxed text-[#0d1c32]/90 mt-2 pr-12 min-h-[48px] flex items-center">
          ...
          <div className="flex items-center justify-between border-t border-[#0d1c32]/10 pt-3 mt-4 relative z-10">
            ...
            <div className="flex gap-1.5">
              <button 
                ...
                className="w-7 h-7 bg-white rounded-full flex items-center justify-center border border-black/5 active:scale-90 transition-all"
              >
        ...
        <div className="bg-white rounded-[28px] p-5.5 card-shadow border border-outline-variant/40 flex flex-col justify-between w-full">
          <div className="flex justify-between items-center pb-2 border-b border-outline-variant/25">
            ...
            <button 
              ...
              className="flex items-center gap-1 bg-surface border border-outline-variant/20 rounded-xl px-2.5 py-1 text-[9px] font-black text-[#0d1c32] hover:bg-slate-50 active:scale-95 transition-all"
            >
          ...
          <blockquote className="text-[11.5px] font-semibold text-slate-600 leading-relaxed italic text-left mt-3">
      ...
      <section className="bg-white rounded-[28px] p-5.5 card-shadow border border-outline-variant/40 space-y-4.5 w-full">
        ...
        <div className="space-y-3.5">
          ...
          <div className="p-4 bg-surface rounded-2xl border border-outline-variant/15 space-y-2">
            ...
            <ul className="list-disc pl-5 text-[11px] font-medium text-slate-600 space-y-1 leading-normal">
      ...
      <section className="space-y-4 w-full">
        ...
        <div className="bg-white rounded-[28px] p-5.5 card-shadow border border-outline-variant/40 w-full space-y-3.5">
          <h4 className="font-display font-bold text-[11px] text-slate-500 uppercase tracking-wider block">Timeline Success Forecast</h4>
          
          <div className="divide-y divide-outline-variant/15 text-[11px] font-semibold text-slate-600">
